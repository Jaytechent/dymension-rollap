...
const DYMENSION_CONNECT_URL = 'https://playground.dymension.xyz/rollapps/gmcadsshiba_10708-1';
const DYMENSION_CONNECT_NETWORK_IDS = ['gmcadsshiba_10708-1'];
...
function App() {
    ...
    return (
        <div className='App'>
            <h1>The Best Bird on Dymension</h1>

            <h3>Transfer and stake tokens</h3>
            <h3>Deposit down here and Trade</h3>
            <button
